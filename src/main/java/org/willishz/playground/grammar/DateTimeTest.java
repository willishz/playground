...
public class DateTimeTest {
    ...
    @Test
    public void test() {
        LocalDateTime ldtm = LocalDateTime.of(2019, 8, 1, 0, 0, 0); // 代替Date
        ...
        final Clock clock = Clock.systemUTC(); // Get the system clock as UTC offset,代替System.currentTimeMillis()
